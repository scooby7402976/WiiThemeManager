...
void MRC_Draw_String2(int x, int y, u32 color, const char* str){
	...
	for(;;){
		...
		ch-=32;
		//MRC_Draw_Tile(x, y, font, FONT_WIDTH, c);
		c = (char*)(font2->buffer)+ch*FONT_WIDTH*4;
		for (iy=0; iy<font2->height; iy++){
			bg = (char*)framebufferRGBA + (y+iy)*(vmode->fbWidth * 4) + x*4;
			for(ix=0; ix<FONT_WIDTH; ix++){
				png_composite(bg[0], r, c[3], bg[0]); // r
				png_composite(bg[1], g, c[3], bg[1]); // g
...
static const u8 mask[MASK_H][MASK_W]={
	{0, 0, 0, 0, 0, 0, 0, 0, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 208, 208, 208, 208, 208, 208, 208},
	{0, 0, 0, 0, 0, 0, 0, 128, 128, 128, 208, 208, 208, 208, 208, 208, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255},
	{0, 0, 0, 0, 0, 128, 128, 208, 208, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255},
	{0, 0, 0, 128, 128, 208, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255},
	{0, 0, 128, 128, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255},
	{0, 0, 128, 208, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255},
	{0, 0, 208, 208, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255},
...
void MRC_Init(){
	...
	font2 = MRC_Load_Texture((void*)font2_png);
